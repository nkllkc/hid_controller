...
TOUCH_REPORT = NULL_CHAR * 2 + chr(TOUCH) + NULL_CHAR * 5 + NULL_REPORT + NULL_REPORT
PRESS_REPORT = NULL_CHAR * 2 + chr(PRESS) + NULL_CHAR * 5  + NULL_REPORT
RELEASE_REPORT = NULL_CHAR * 2 + chr(RELEASE) + NULL_CHAR * 5  + NULL_REPORT
PRESS_RELEASE_REPORT = NULL_CHAR * 2 + chr(PRESS) + NULL_CHAR * 5  + NULL_REPORT + NULL_CHAR * 2 + chr(RELEASE) + NULL_CHAR * 5  + NULL_REPORT
DOUBLE_TOUCH =  TOUCH_REPORT + TOUCH_REPORT
